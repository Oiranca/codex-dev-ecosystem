...
Because context is not shared natively, the agent performing the search must **Communicate** the findings clearly in the **current Codex thread** so the next agent knows exactly which files to claim.
